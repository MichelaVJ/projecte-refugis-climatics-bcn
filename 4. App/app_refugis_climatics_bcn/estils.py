...
estils.py
---------
Petits ajustos visuals compartits per les dues pàgines de l'app (color dels
títols i mètriques destacades), seguint la paleta "A · Marea". És l'únic
lloc del projecte on s'injecta CSS via `st.markdown` — es crida un cop a
cada pàgina, just després de `st.set_page_config`.
"""
